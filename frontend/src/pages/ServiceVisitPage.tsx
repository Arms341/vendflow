...
export default function ServiceVisitPage() {
  ...
  const items: ServiceVisitItem[] = Array.isArray(data) ? data : data?.items ?? [];
  const columns = ['id', 'name'];

  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Service Visits</h1>
